...
const (
	ReportResourceCreation ReportType = "resource-creation"
...
// ResourceCreationReport captures a full resource-inflater benchmark run.
type ResourceCreationReport struct {
	ReportMeta
	Config      ResourceCreationConfig `json:"config"`
	Results     []InflationResult      `json:"results"`
	ClusterInfo *ClusterInfo           `json:"clusterInfo,omitempty"`
	APILatency  []LatencyMeasurement   `json:"apiLatency,omitempty"`
}

// ResourceCreationConfig holds the parameters used for the run.
type ResourceCreationConfig struct {
